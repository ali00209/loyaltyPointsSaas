...
/**
 * loyaltyhub theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { loyaltyhubTheme } from './loyaltyhub';
 *   import './loyaltyhub.css';
 */
export const loyaltyhubTheme = {
  name: 'loyaltyhub',
  __built: true,
  tokens: {
    ...
    "--color-accent-muted": "light-dark(#EEF2FF, #4F46E53D)",
    "--color-neutral": "light-dark(#0000000F, #FFFFFF1A)",
    "--color-brand-gold": "light-dark(#FBBF24, #FBBF24)",
    "--color-brand-ink": "light-dark(#312E81, #312E81)",
    ...
    "--color-on-accent": "light-dark(#ffffff, #1E1B4B)",
