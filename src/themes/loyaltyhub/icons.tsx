 ...
 * @output Exports loyaltyhubIconRegistry for the loyaltyhub theme
 * @position Icon configuration for the loyaltyhub theme; consumed by index.ts
 *
 * Maps semantic icon names to Lucide icon components.
 * These icons are bundled with the theme, not with @astryxdesign/core.
 *
 * Note: IconRegistry only accepts the built-in IconName keys. App-specific
 * icons are passed as components (IconType) directly at the call site.
 */
...
export const loyaltyhubIconRegistry: IconRegistry = {
  close: <X {...iconProps} />,
