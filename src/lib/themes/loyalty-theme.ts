...
export const loyaltyTheme = defineTheme({
  name: "loyalty",
  tokens: {
    "--color-accent": "light-dark(#2563EB, #3B82F6)",
    "--color-accent-muted": "light-dark(#f1f1f1, #262626)",
    "--color-on-accent": "light-dark(#ffffff, #111111)",
    "--color-neutral": "light-dark(#64748B0F, #7373731A)",
    "--color-background-surface": "light-dark(#F8FAFC, #0F0F0F)",
    "--color-background-body": "light-dark(#F1F5F9, #090909)",
    ...
    "--color-background-muted": "light-dark(#94A3B8, #A3A3A3)",
    "--color-text-primary": "light-dark(#0F172A, #FAFAFA)",
  ...
  components: {
    ...
    badge: {
      ...
      "variant:success": {
        backgroundColor:
          "var(--astryx-theme-neutral-color-status-fill-success)",
        color: "var(--color-on-success)",
      },
      "variant:warning": {
        backgroundColor:
          "var(--astryx-theme-neutral-color-status-fill-warning)",
